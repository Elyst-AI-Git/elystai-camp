import type {CalendarBlock,DailyHours,Invoice,Lead,Metric,PersonalTransaction,Reimbursement,RestDay,Settings,Sprint,Task,TaskSlipReason,Transaction,User,WeeklyGoal,WorkdayLog} from '../types';
...
export const workdayLogs:WorkdayLog[]=[];
